# Python TCP server pro řízení robotů
## Úvod
Toto je implementace mojí semestrální práce v předmětu BI-PSI na ČVUT FIT napsaná v Pythonu.
...
Můj kód prošel všechny povinné i volitelné testy, tedy 20/20 bodů.
:-) Enjoy

## Tester
Tester je nutné extrahovat a spustit na Linuxovém systému. (Nebo na Windowsu pod WSL).
V souboru config.py se dá nastavit port na kterém server naslouchá a klíče pro komunikaci.
[Odkaz na tester](./tester/)
